...

{
  ...
  "dia_chi": "địa chỉ thường trú đầy đủ — phần sau nhãn 'Nơi thường trú/Place of residence' trên CCCD THƯỜNG IN THÀNH 2 DÒNG (dòng 1 ngay sau nhãn, dòng 2 xuống hàng tiếp theo) — PHẢI đọc và nối liền CẢ 2 DÒNG thành 1 địa chỉ đầy đủ (thôn/xã/huyện/tỉnh), không được bỏ sót phần đầu ở dòng 1. BẮT BUỘC giữ nguyên dấu tiếng Việt y như trên ảnh (KHÔNG được bỏ dấu, vd phải là 'Xóm 6, Gia Sinh, Gia Viễn, Ninh Bình', KHÔNG được viết 'Xom 6, Gia Sinh, Gia Vien, Ninh Binh'), và giữa các cụm (thôn/xã/huyện/tỉnh) phải có dấu phẩy rồi một khoảng trắng, không viết dính liền.",
...
2. Trích xuất và GỘP thông tin của người này vào một bộ field duy nhất. Quy tắc ưu tiên khi 1 field xuất hiện ở nhiều ảnh:
   - "ho_ten", "so_cccd", "ngay_sinh", "ngay_cap", "noi_cap", "dia_chi": lấy từ CCCD gốc (rõ nét, chính xác pháp lý) nếu có, chỉ lấy từ ảnh xác nhận khi không có CCCD gốc.
     ...
     + "dia_chi": phần sau nhãn "Nơi thường trú/Place of residence" trên CCCD THƯỜNG IN THÀNH 2 DÒNG (dòng 1 ngay sau nhãn, dòng 2 xuống hàng tiếp theo) — PHẢI đọc và nối liền CẢ 2 DÒNG thành 1 địa chỉ đầy đủ, không được bỏ sót phần đầu ở dòng 1. BẮT BUỘC giữ nguyên dấu tiếng Việt y như trên ảnh (KHÔNG bỏ dấu, vd phải là "Xóm 6, Gia Sinh, Gia Viễn, Ninh Bình", KHÔNG được viết "Xom 6, Gia Sinh, Gia Vien, Ninh Binh"), các cụm cách nhau bằng dấu phẩy rồi một khoảng trắng, không viết dính liền.
