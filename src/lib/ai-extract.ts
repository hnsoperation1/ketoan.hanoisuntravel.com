...
Đọc các ảnh được cung cấp và trích xuất vào JSON với các trường sau (bỏ qua trường không tìm thấy trong ảnh, KHÔNG bịa đặt). Mọi trường chữ (ho_ten, dia_chi, noi_cap...) PHẢI giữ nguyên dấu tiếng Việt như in trên ảnh gốc — TUYỆT ĐỐI không bỏ dấu (vd phải ghi "Ngô Văn Hiếu", KHÔNG ghi "Ngo Van Hieu"):

{
  ...
  "dia_chi": "địa chỉ thường trú đầy đủ — phần sau nhãn 'Nơi thường trú/Place of residence' trên CCCD THƯỜNG IN THÀNH 2 DÒNG (dòng 1 ngay sau nhãn, dòng 2 xuống hàng tiếp theo) — PHẢI đọc và nối liền CẢ 2 DÒNG thành 1 địa chỉ đầy đủ (thôn/xã/huyện/tỉnh), không được bỏ sót phần đầu ở dòng 1. BẮT BUỘC giữ nguyên dấu tiếng Việt y hệt ký tự in trên chính ảnh CCCD này (KHÔNG được bỏ dấu). Giữa các cụm (thôn/xã/huyện/tỉnh) phải có dấu phẩy rồi một khoảng trắng, không viết dính liền — đúng định dạng là '<cụm 1>, <cụm 2>, <cụm 3>, <cụm 4>' (đây CHỈ minh hoạ cách ngắt dấu phẩy/khoảng trắng, KHÔNG phải giá trị mẫu, phải thay bằng đúng chữ đọc được trên ảnh). CHỈ được chép đúng ký tự nhìn thấy trên ảnh — TUYỆT ĐỐI KHÔNG được dùng bất kỳ địa danh nào xuất hiện trong hướng dẫn/ví dụ ở trên làm câu trả lời, cũng không tự suy đoán/hoàn thiện dựa trên hiểu biết chung dù chữ bị mờ/nghiêng/khuất một phần; nếu một đoạn không đọc rõ, chỉ ghi phần đọc được và để trống phần còn lại.",
...
2. Trích xuất và GỘP thông tin của người này vào một bộ field duy nhất. Quy tắc ưu tiên khi 1 field xuất hiện ở nhiều ảnh:
   - "ho_ten", "so_cccd", "ngay_sinh", "ngay_cap", "noi_cap", "dia_chi": lấy từ CCCD gốc (rõ nét, chính xác pháp lý) nếu có, chỉ lấy từ ảnh xác nhận khi không có CCCD gốc.
     ...
     + "dia_chi": phần sau nhãn "Nơi thường trú/Place of residence" trên CCCD THƯỜNG IN THÀNH 2 DÒNG (dòng 1 ngay sau nhãn, dòng 2 xuống hàng tiếp theo) — PHẢI đọc và nối liền CẢ 2 DÒNG thành 1 địa chỉ đầy đủ, không được bỏ sót phần đầu ở dòng 1. BẮT BUỘC giữ nguyên dấu tiếng Việt y hệt ký tự in trên chính ảnh CCCD của người này (KHÔNG bỏ dấu). Các cụm cách nhau bằng dấu phẩy rồi một khoảng trắng, không viết dính liền — đúng định dạng là "<cụm 1>, <cụm 2>, <cụm 3>, <cụm 4>" (đây CHỈ minh hoạ cách ngắt dấu phẩy/khoảng trắng, KHÔNG phải giá trị mẫu, phải thay bằng đúng chữ đọc được trên ảnh). CHỈ được chép đúng ký tự nhìn thấy trên ảnh CCCD gốc của người này — TUYỆT ĐỐI KHÔNG được dùng bất kỳ địa danh nào xuất hiện trong hướng dẫn/ví dụ ở trên làm câu trả lời, cũng không tự suy đoán/hoàn thiện dựa trên hiểu biết chung hay ảnh khác trong cùng bộ, kể cả khi chữ mờ/nghiêng/khuất một phần; nếu một đoạn không đọc rõ, chỉ ghi phần đọc được và để trống phần còn lại.
...
3. Trường nào không tìm thấy ở bất kỳ ảnh nào thì bỏ qua, KHÔNG bịa đặt. Kể cả khi tìm thấy nhưng chữ mờ/nghiêng/khuất một phần, chỉ chép đúng phần đọc rõ được — KHÔNG tự suy đoán/hoàn thiện phần còn lại dựa trên hiểu biết chung, đặc biệt với "dia_chi" (tuyệt đối không đoán ra tên thôn/xã/huyện/tỉnh nghe hợp lý nếu không đọc rõ trên ảnh).
...
5. QUAN TRỌNG: mọi trường là chữ (ho_ten, dia_chi, noi_cap...) PHẢI giữ nguyên dấu tiếng Việt như trên ảnh gốc — TUYỆT ĐỐI không bỏ dấu.
