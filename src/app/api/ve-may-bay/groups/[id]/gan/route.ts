...
// gán (hoặc bỏ gán nếu null) TKT và/hoặc mã khách mặc định cho 1 nhóm
// Telegram. Chỉ field nào có mặt trong body mới bị ghi đè (dùng 'in' thay
// vì kiểm tra truthy để phân biệt được "cố tình gửi null để xoá" với
// "không gửi field này").
