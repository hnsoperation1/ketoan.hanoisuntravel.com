...
import { RefreshCw, Search, ChevronRight, ShieldCheck, X } from 'lucide-react'
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <div className="relative ml-auto">
          ...
          <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Tìm TKT, nhóm, người gửi, nội dung..."
            className="pl-8 pr-8 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-400 w-72" />
          {search && (
