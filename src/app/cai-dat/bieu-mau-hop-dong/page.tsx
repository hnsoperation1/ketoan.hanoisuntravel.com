...
const PLACEHOLDER_GROUPS: { title: string; fields: { tag: string; label: string }[] }[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { tag: 'diem_don_tra', label: 'Điểm đón/trả khách' },
      { tag: 'dieu_hanh_phu_trach', label: 'Điều hành phụ trách' },
      { tag: 'dieu_hanh_dien_thoai', label: 'Điện thoại điều hành' },
  ...
  },
  {
    ...
    fields: [
      ...
      { tag: 'ngay_ky', label: 'Ngày ký (vd: ngày 16 tháng 07 năm 2026)' },
